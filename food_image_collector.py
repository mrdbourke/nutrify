...
st.write(
    "Upload or take a photo of your food and help build the world's \
            biggest food image database!"
)
...
if submit_button:
    ...
    image_info = [
        [unique_image_id, current_time, img_height, img_width, label]
    ]
